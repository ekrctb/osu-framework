...
namespace osu.Framework.Graphics
{
    public static class Vector2Extensions
    {
        ...
        {
            var w = mat.Row0.Z * pos.X + mat.Row1.Z * pos.Y + mat.Row2.Z;
            var invW = w == 1 ? 1 : 1 / w;
            result.X = (mat.Row0.X * pos.X + mat.Row1.X * pos.Y + mat.Row2.X) * invW;
            result.Y = (mat.Row0.Y * pos.X + mat.Row1.Y * pos.Y + mat.Row2.Y) * invW;
        }
